...
public class Residencial extends Imovel {
	...
	public Residencial(int numero, String tipo, String descricao, Corretor corretor,
			boolean tipoDeRegistro, double valor, int numComodos, int numAndares, String localizacao) {
